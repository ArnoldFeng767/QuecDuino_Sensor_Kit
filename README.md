...
| 12   | [魔术光环模块（KY-027）](example/12-魔术光环模块(KY-027)/README.md) | 魔术光环模块（KY‑027）是倾斜感应 + LED 发光二**合一数字模块，内置水银开关与高亮 LED，用于倾斜检测、姿态触发、状态指示、创客互动项目。 |
...
| 16   | [数码管模块(JY005)](example/16-数码管模块(JY005)/README.md)  | 单位数码管模块是**数字显示器件**，由 7 段发光二极管组成，用于显示 0-9 数字及简单符号，广泛用于计数、计时、状态显示、创客 DIY 场景。 |
