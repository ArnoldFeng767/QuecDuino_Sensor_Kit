...
| 13   | [Tilt Switch Module (KY-020)](example/13-Inclination_switch_module(KY-20)/README.md) | A digital posture-sensing switch device, also known as a ball switch or tilt sensor. It is commonly used for tilt detection, anti-tip protection, posture triggering, and smart alarm scenarios. |
