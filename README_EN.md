...
| 12   | [Magic Light Cup Module (KY-027)](example/12Magic_Aura_Module(KY-027)/README.md) | The KY-027 Magic Light Cup module combines tilt sensing and LED lighting. It has a built-in mercury switch and high-brightness LED, and is used for tilt detection, posture triggering, status indication, and maker interaction projects. |
